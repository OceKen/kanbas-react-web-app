      ...
      <table className="table table-sm">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>Matematica.multiply(3, 4) ={Matematica.multiply(5, 1)}</td>
            <td>multiply(3, 4) = {multiply(5, 1)}</td>
          </tr>
          <tr>
            <td>Math.subtract(8, 2) = {Math.divide(5, 1)}</td>
            <td>Matematica.subtract(8, 2) ={Matematica.divide(5, 1)}</td>
            <td>subtract(8, 12) = {divide(5, 1)}</td>
          </tr>
        </tbody>
      </table>
      <hr />
